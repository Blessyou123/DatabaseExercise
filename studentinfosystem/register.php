<?php 
  ...
  if(isset($_POST['register'])) {
    ...
    $eadd = clean($_POST['emailaddress']);
    $hadd = clean($_POST['homeaddress']); 
    $course = clean($_POST['course']); 
    $mnum = clean($_POST['mobilenumber']); 
    ...
    if(mysqli_num_rows($result) == 0) {
      ...
      if(mysqli_num_rows($result) == 0) {
        ...
        $query = "INSERT INTO students (username, password, studentno, firstname, lastname, middlename, emailaddress, homeaddress, course, mobilenumber, date_joined)
        VALUES ('$uname', '$pword', '$studno', '$fname', '$lname', '$mname', '$eadd', '$hadd', '$course', '$mnum', NOW())";
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="row">
	      ...
	      <div class="form-group">
                ...
                <input type="text" class="form-control" name="eadd" placeholder="Email Address" required>
              </div>
	      
	      <div class="form-group">
                <label for="hadd">Home Address</label>
                <input type="text" class="form-control" name="hadd" placeholder="Home Address" required>
              </div>
	      ...
	      <div class="form-group">
                ...
                <input type="text" class="form-control" name="madd" placeholder="Mobile Number" required>
              </div>
