...
<body>
  ...
  <section>
    ...
    <div class="profile-box box-left">
	  ...
	  echo "<div class='info'><strong>Middle Name:</strong> <span>".$row['middlename']."</span></div>";
	  echo "<div class='info'><strong>Email Address:</strong> <span>".$row['emailaddress']."</span></div>";
	  echo "<div class='info'><strong>Home Address:</strong> <span>".$row['homeaddress']."</span></div>";
          echo "<div class='info'><strong>Course:</strong> <span>".$row['course']."</span></div>";
          echo "<div class='info'><strong>Mobile Number:</strong> <span>".$row['mobilenumber']."</span></div>";
