<?php 
	...
	$query = "SELECT studentno, firstname, lastname, middlename, emailaddress, homeaddress, course, mobilenumber, CONCAT(firstname, ' ', lastname) as fullname 
	...
	if($result = mysqli_query($con, $query)) {
		...
		if(mysqli_num_rows($result) == 0) {
			...
			while($row = mysqli_fetch_assoc($result)) {
				...
				echo "<span><strong>yr level: </strong>".$row['mobilenumber']."</span>";
