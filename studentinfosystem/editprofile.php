<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "UPDATE students SET firstname = '$fname', lastname = '$lname', middlename = '$mname', emailaddress = '$eadd', homeaddress = '$hadd', course = '$course', mobilenumber = '$mnum'
...
<body>
  ...
  <section>
	...
	<div class="form-group">
          ...
          <input type="text" class="form-control" name="emailaddress" placeholder="emailaddress" required>
        </div>
