  ...
  <section>
    ...
    <?php
        ...
        if($result = mysqli_query($con, $query)) {
		  ...
		  <div class='info'><strong>Middle Name:</strong> <span><?php echo $row['middlename']; ?></span></div>
		  <div class='info'><strong>Email Address:</strong> <span><?php echo $row['eadd']; ?></span></div>
		  <div class='info'><strong>Home Address:</strong> <span><?php echo $row['hadd']; ?></span></div>
                  <div class='info'><strong>Course:</strong> <span><?php echo $row['course']; ?></span></div>
                  <div class='info'><strong>Mobile Number:</strong> <span><?php echo $row['mobilenumber']; ?></span></div>
